...
Example:
    uv run diagram_generator.py graph.txt graphviz diagram.svg
    uv run diagram_generator.py uml.txt plantuml
    uv run diagram_generator.py flow.txt mermaid flowchart.svg
"""
